...
// see http://github.com/facebook/react/blob/b5ac963fb791d1298e7f396236383bc955f916c1/src/isomorphic/classic/element/ReactElement.js#L21-L25
...
function formatProdErrorMessage(code) {
  return `Minified Redux error #${code}; visit http://redux.js.org/Errors?code=${code} for the full message or use the non-minified dev environment for full errors. `;
}
...
function hasResolvingSelectors(state) {
  return Object.values(state).some(
    (selectorState) => (
       ...
       *
       * @see http://github.com/aduth/equivalent-key-map
       */
...
/*!
 * is-plain-object <http://github.com/jonschlinkert/is-plain-object>
 *
