...
(function(window, document, undefined) {
    ...
    for (i = 0; i <= 9; ++i) {
        ...
        // event.
        //
        // @see http://github.com/ccampbell/mousetrap/pull/258
...
var ClipboardActionCopy = function ClipboardActionCopy(target) {
  ...
  if (typeof target === 'string') {
    ...
    // If input type doesn't support `setSelectionRange`. Simulate it. http://developer.mozilla.org/en-US/docs/Web/API/HTMLInputElement/setSelectionRange
...
function E () {
  ...
  // (via http://github.com/lipsmack from http://github.com/scottcorgan/tiny-emitter/issues/3)
}
...
E.prototype = {
  ...
  off: function (name, callback) {
    ...
    // Suggested by http://github.com/lazd
    // Ref: http://github.com/scottcorgan/tiny-emitter/commit/c6ebfaa9bc973b33d110a84a307742b7cf94c953#commitcomment-5024910
