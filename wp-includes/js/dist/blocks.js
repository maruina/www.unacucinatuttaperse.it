...
function getDefaultOpts (simple) {
  ...
  var defaultOptions = {
    ...
    ghMentionsLink: {
      defaultValue: 'http://github.com/{u}',
...
showdown.helper.emojis = {
  ...
  /* special emojis :P */
  'octocat':  '<img alt=":octocat:" height="20" width="20" align="absmiddle" src="http://assets-cdn.github.com/images/icons/emoji/octocat.png">',
 ...
 *
 * List of supported emojis: http://github.com/showdownjs/showdown/wiki/Emojis
 */
...
See: http://developer.wordpress.org/block-editor/reference-guides/block-api/block-api-versions/#version-3-wordpress-6-3`
    );
  }
  ...
  if (!isValidIcon(settings.icon.src)) {
    external_wp_warning_default()(
      "The icon passed is invalid. The icon should be a string, an element, a function, or an object following the specifications documented in http://developer.wordpress.org/block-editor/developers/block-api/block-registration/#icon-optional"
    );
    return;
  }
...
/**
 * generated from http://raw.githubusercontent.com/w3c/html/26b5126f96f736f796b9e29718138919dd513744/entities.json
 * do not edit
 */
var namedCharRefs = {
...
function isNodeOfType(node, type) {
  external_wp_deprecated_default()("wp.blocks.node.isNodeOfType", {
    since: "6.1",
    version: "6.3",
    link: "http://developer.wordpress.org/block-editor/how-to-guides/block-tutorial/introducing-attributes-and-editable-fields/"
  });
