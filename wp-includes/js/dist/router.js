...
// See http://github.com/tildeio/route-recognizer/pull/55
 ...
 *
 * @see http://github.com/remix-run/history/tree/main/docs/api-reference.md#action
 */
var Action;
 ...
 *
 * @see http://github.com/remix-run/history/tree/main/docs/api-reference.md#createbrowserhistory
 */
  ...
  var history = {
    ...
    block: function block(blocker) {
      ...
      return function () {
        ...
        // See http://html.spec.whatwg.org/#unloading-documents
 ...
 *
 * @see http://github.com/remix-run/history/tree/main/docs/api-reference.md#createhashhistory
 */
...
function createHashHistory(options) {
  ...
  // http://developer.mozilla.org/de/docs/Web/API/Window/popstate_event
 ...
 *
 * @see http://github.com/remix-run/history/tree/main/docs/api-reference.md#creatememoryhistory
 */
 ...
 *
 * @see http://github.com/remix-run/history/tree/main/docs/api-reference.md#createpath
 */
 ...
 *
 * @see http://github.com/remix-run/history/tree/main/docs/api-reference.md#parsepath
 */
