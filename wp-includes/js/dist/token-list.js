...
class TokenList {
   ...
   *
   * @see http://dom.spec.whatwg.org/#dom-domtokenlist-value
   *
   ...
   *
   * @see http://dom.spec.whatwg.org/#dom-domtokenlist-length
   *
   ...
   *
   * @see http://dom.spec.whatwg.org/#DOMTokenList-stringification-behavior
   * @see http://www.ecma-international.org/ecma-262/9.0/index.html#sec-tostring
   *
   * @return Token set as string.
   */
  toString() {
   ...
   *
   * @see http://dom.spec.whatwg.org/#domtokenlist
   *
  ...
  *[Symbol.iterator]() {
   ...
   *
   * @see http://dom.spec.whatwg.org/#dom-domtokenlist-item
   *
   ...
   *
   * @see http://dom.spec.whatwg.org/#dom-domtokenlist-contains
   *
   ...
   *
   * @see http://dom.spec.whatwg.org/#dom-domtokenlist-remove
   *
   ...
   *
   * @see http://dom.spec.whatwg.org/#dom-domtokenlist-replace
   *
   ...
   *
   * @param _token
   * @see http://dom.spec.whatwg.org/#dom-domtokenlist-supports
   *
