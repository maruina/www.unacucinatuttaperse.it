...
// http://tc39.github.io/ecma262/#sec-array.prototype-@@unscopables
...
// http://tc39.github.io/ecma262/#sec-array.from
...
module.exports = {
  ...
  // http://tc39.github.io/ecma262/#sec-array.prototype.includes
  includes: createMethod(true),
  // `Array.prototype.indexOf` method
  // http://tc39.github.io/ecma262/#sec-array.prototype.indexof
...
// http://tc39.github.io/ecma262/#sec-%iteratorprototype%-object
...
// http://tc39.github.io/ecma262/#sec-object.assign
...
// http://tc39.github.io/ecma262/#sec-object.create
...
// http://tc39.github.io/ecma262/#sec-object.defineproperties
...
// http://tc39.github.io/ecma262/#sec-object.defineproperty
...
// http://tc39.github.io/ecma262/#sec-object.getownpropertydescriptor
...
// http://tc39.github.io/ecma262/#sec-object.getownpropertynames
...
// http://tc39.github.io/ecma262/#sec-object.getprototypeof
...
// `Object.keys` method
// http://tc39.github.io/ecma262/#sec-object.keys
...
// http://tc39.github.io/ecma262/#sec-object.prototype.propertyisenumerable
...
// http://tc39.github.io/ecma262/#sec-object.setprototypeof
...
// http://tc39.github.io/ecma262/#sec-requireobjectcoercible
module.exports = function (it) {
...
module.exports = {
  ...
  // http://tc39.github.io/ecma262/#sec-string.prototype.codepointat
...
'use strict';
// based on http://github.com/bestiejs/punycode.js/blob/master/punycode.js
...
// http://tc39.github.io/ecma262/#sec-tointeger
...
// http://tc39.github.io/ecma262/#sec-tolength
module.exports = function (argument) {
...
// http://tc39.github.io/ecma262/#sec-toobject
module.exports = function (argument) {
...
// http://tc39.github.io/ecma262/#sec-array.prototype.entries
// `Array.prototype.keys` method
// http://tc39.github.io/ecma262/#sec-array.prototype.keys
// `Array.prototype.values` method
// http://tc39.github.io/ecma262/#sec-array.prototype.values
// `Array.prototype[@@iterator]` method
// http://tc39.github.io/ecma262/#sec-array.prototype-@@iterator
// `CreateArrayIterator` internal method
// http://tc39.github.io/ecma262/#sec-createarrayiterator
...
// http://tc39.github.io/ecma262/#sec-%arrayiteratorprototype%.next
}, function () {
...
// http://tc39.github.io/ecma262/#sec-createunmappedargumentsobject
// http://tc39.github.io/ecma262/#sec-createmappedargumentsobject
...
// http://tc39.github.io/ecma262/#sec-string.prototype-@@iterator
...
// http://tc39.github.io/ecma262/#sec-%stringiteratorprototype%.next
}, function next() {
  var state = getInternalState(this);
...
redefineAll(URLSearchParamsPrototype, {
  ...
  // http://url.spec.whatwg.org/#dom-urlsearchparams-append
  ...
  // http://url.spec.whatwg.org/#dom-urlsearchparams-getall
  ...
  // http://url.spec.whatwg.org/#dom-urlsearchparams-sort
  sort: function sort() {
    var state = getInternalParamsState(this);
    var entries = state.entries;
...
// http://url.spec.whatwg.org/#urlsearchparams-stringification-behavior
...
// http://github.com/zloirock/core-js/issues/674
...
// `URL` constructor
// http://url.spec.whatwg.org/#url-class
...
// http://url.spec.whatwg.org/#dom-url-tojson
redefine(URLPrototype, 'toJSON', function toJSON() {
  return serializeURL.call(this);
}, { enumerable: true });

// `URL.prototype.toString` method
// http://url.spec.whatwg.org/#URL-stringification-behavior
...
if (NativeURL) {
  ...
  // http://developer.mozilla.org/en-US/docs/Web/API/URL/createObjectURL
  // eslint-disable-next-line no-unused-vars
  if (nativeCreateObjectURL) redefine(URLConstructor, 'createObjectURL', function createObjectURL(blob) {
    return nativeCreateObjectURL.apply(NativeURL, arguments);
  });
  // `URL.revokeObjectURL` method
  // http://developer.mozilla.org/en-US/docs/Web/API/URL/revokeObjectURL
  // eslint-disable-next-line no-unused-vars
