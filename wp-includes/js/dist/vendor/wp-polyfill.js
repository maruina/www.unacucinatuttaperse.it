 ...
 * license: http://github.com/zloirock/core-js/blob/v3.39.0/LICENSE
...
// http://tc39.es/ecma262/#sec-get-arraybuffer.prototype.detached
...
module.exports = function (fn) {
  // Nashorn bug:
  //   http://github.com/zloirock/core-js/issues/1128
  //   http://github.com/zloirock/core-js/issues/1130
...
// http://tc39.es/proposal-arraybuffer-transfer/#sec-arraybuffer.prototype.transfer
...
// `Math.trunc` method
// http://tc39.es/ecma262/#sec-math.trunc
...
// http://tc39.es/proposal-arraybuffer-transfer/#sec-arraybuffer.prototype.transfertofixedlength
if ($transfer) $({ target: 'ArrayBuffer', proto: true }, {
...
// `Map.groupBy` method
// http://tc39.es/ecma262/#sec-map.groupby
...
// http://tc39.es/ecma262/#sec-object.groupby
...
// `Promise.try` method
// http://tc39.es/ecma262/#sec-promise.try
...
// http://tc39.es/ecma262/#sec-promise.withResolvers
...
// http://github.com/Jarred-Sumner/bun/issues/399
var BUGGY_DESCRIPTOR = !!descriptor && !(descriptor.writable && descriptor.configurable);

var FORCED_CONSTRUCTOR = ERROR_HAS_STACK && !BUGGY_DESCRIPTOR && !DOM_EXCEPTION_HAS_STACK;

// `DOMException` constructor patch for `.stack` where it's required
// http://webidl.spec.whatwg.org/#es-DOMException-specialness
...
// http://github.com/whatwg/html/pull/5749
...
// http://bugzilla.mozilla.org/show_bug.cgi?id=1556604
// FF103 can clone errors, but `.stack` of clone is an empty string
// http://bugzilla.mozilla.org/show_bug.cgi?id=1778762
// FF104+ fixed it on usual errors, but not on DOMExceptions
// http://bugzilla.mozilla.org/show_bug.cgi?id=1777321
// Chrome <102 returns `null` if cloned object contains multiple references to one error
// http://bugs.chromium.org/p/v8/issues/detail?id=12542
// NodeJS implementation can't clone DOMExceptions
// http://github.com/nodejs/node/issues/41038
...
// http://github.com/nodejs/node/issues/40840
  ...
  switch (type) {
    ...
    case 'File':
      if (nativeRestrictedStructuredClone) try {
        ...
        // NodeJS 20.0.0 bug, http://github.com/nodejs/node/issues/47612
...
// http://html.spec.whatwg.org/multipage/structured-data.html#dom-structuredclone
$({ global: true, enumerable: true, sham: !PROPER_STRUCTURED_CLONE_TRANSFER, forced: FORCED_REPLACEMENT }, {
  structuredClone: function structuredClone(value /* , { transfer } */) {
    ...
    // http://github.com/zloirock/core-js/issues/1265
...
// http://github.com/nodejs/node/issues/47505
// http://github.com/denoland/deno/issues/18893
var THROWS_WITHOUT_ARGUMENTS = USE_NATIVE_URL && fails(function () {
  URL.canParse();
});

// Bun ~ 1.0.30 bug
// http://github.com/oven-sh/bun/issues/9250
var WRONG_ARITY = fails(function () {
  return URL.canParse.length !== 1;
});

// `URL.canParse` method
// http://url.spec.whatwg.org/#dom-url-canparse
...
module.exports = !fails(function () {
  ...
  // http://bugs.chromium.org/p/v8/issues/detail?id=14222
...
// http://github.com/whatwg/url/pull/734
